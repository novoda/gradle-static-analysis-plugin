...
import com.novoda.staticanalysis.internal.idea.IdeaInspectionsConfigurator
...
class StaticAnalysisPlugin implements Plugin<Project> {
    ...
    private static List<CodeQualityConfigurator> createConfigurators(Project project,
        ...
        [
                ...
                IdeaInspectionsConfigurator.create(project, violationsContainer, evaluateViolations)
        ]
    }
}
